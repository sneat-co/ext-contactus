...
func NewContactKey(spaceID coretypes.SpaceID, contactID string) *dal.Key {
	...
	return dal.NewKeyWithParentAndID(spaceModuleKey, const4contactus.ContactsCollection, contactID)
}
...
func NewContactRecord(spaceID coretypes.SpaceID, contactID string) dal.Record {
	return dal.NewRecordWithData(NewContactKey(spaceID, contactID), new(map[string]any))
}
